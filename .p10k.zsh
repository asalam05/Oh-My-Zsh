# --- AWS Profile segment for Powerlevel10k ---
function aws_profile_p10k() {
  [[ -n "$AWS_PROFILE" ]] && p10k segment -b 220 -f 0 -i 'AWS' -t "$AWS_PROFILE"
}

# Add aws_profile_p10k to left prompt elements if not present
if [[ -z "${POWERLEVEL9K_LEFT_PROMPT_ELEMENTS[(r)aws_profile_p10k]}" ]]; then
  POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(aws_profile_p10k ${POWERLEVEL9K_LEFT_PROMPT_ELEMENTS[@]})
fi
# Generated by Powerlevel10k configuration wizard on 2025-08-10 at 12:45 IST.
